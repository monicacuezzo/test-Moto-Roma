...
function configurar_blog() {
    ...
    // blog_margen = (screen.width < 520) ? 20 : (blog_contenedor.getBoundingClientRect().width * 0.01)+3;esto si
    blog_margen = (screen.width < 520) ? 20 : 16;
    blog_cantidad = (screen.width < 520) ? 1 : 2;
    // blog_width = Math.floor(document.getElementById('contenedor').clientWidth / blog_cantidad) - blog_margen; esto no

    // blog_width = (screen.width < 520) ? ((document.getElementById('blog__contenedor').getBoundingClientRect().width / blog_cantidad) - blog_margen) : (document.getElementById('blog__contenedor').getBoundingClientRect().width / blog_cantidad); esto si
