...
function configurar_blog() {
    ...
    generar(blog_width,blog_dots,blog_contenido,blog_li,"cuadro_",blog_indice,blog_galeria,blog_cantidad, blog_desplaza,"blog__marcador-activo");
    ...
    desplazar_blog = setInterval(function(){
        if (blog_galeria.clientWidth > document.getElementById('blog__contenedor').clientWidth) {
            blog_indice = desplazar_galeria(blog_galeria,blog_indice,blog_width,blog_margen,blog_contenido,blog_desplaza,"blog__marcador-activo",blog_cantidad,"cuadro_");
        }
    },3000);
...
function blog_avanzar1(){
    ...
    detener_blog();
    blog_indice = desplazar1(blog_galeria,blog_indice,blog_width,blog_margen,blog_contenido,blog_desplaza,"blog__marcador-activo",blog_cantidad,"cuadro_");
    avanzar_blog();
}; 
